...
const translations = {
  "zh-Hant": {
    "top.event.name": "中區禱告會",
    "top.event.theme": "8月4日（週二）晚上 7:30–9:00",
    "top.event.detail": "將在本教會舉行",
    "top.event.cta": "了解詳情",
    "brand.title": "生命之光靈糧堂",
    ...
    "missionVerse.kicker": "Church Verse",
    "missionVerse.text": "神愛世人，甚至將祂的獨生子賜給他們，叫一切信祂的，不至滅亡，反得永生。",
    "missionVerse.reference": "約翰福音 3:16",
    ...
    "welcome.copy2": "我們以中文敬拜、聖經教導、小組聚會、兒童主日學與團契生活，一同在基督裡敬拜、讀經、禱告，並在彼此陪伴中一同成長。",
  ...
  en: {
    "top.event.name": "Central Auckland Prayer Meeting",
    "top.event.theme": "4 Aug (Tue), 7:30–9:00 PM",
    "top.event.detail": "Held at our church",
    "top.event.cta": "Learn more",
    ...
    "missionVerse.kicker": "Church Verse",
    "missionVerse.text": "For God so loved the world that he gave his one and only Son, that whoever believes in him shall not perish but have eternal life.",
    "missionVerse.reference": "John 3:16",
    "welcome.kicker": "Welcome Home",
    ...
    "welcome.copy2": "We gather for Mandarin worship, biblical teaching, small group gatherings, Children's Sunday School, and fellowship as we worship, pray, study Scripture, and grow together with care and companionship in Christ.",
    "about.kicker": "About Us",

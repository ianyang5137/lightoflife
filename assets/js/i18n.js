const translations = {
  "zh-Hant": {
    ...
    "hero.copy": "在基督裡遇見生命之光，一同敬拜、成長、服事這座城市。",
    "hero.primary": "我是新朋友",
    "hero.secondary": "查看聚會時間",
    "welcome.kicker": "Welcome Home",
    "welcome.title": "歡迎來到生命之光",
    "welcome.copy": "無論你是初次認識信仰、剛搬到奧克蘭，或正在尋找屬靈的家，我們都歡迎你與我們一同敬拜、讀經、禱告，並在真實的群體中成長。",
    ...
    "services.sunday.order1": "會前禱告",
    "services.sunday.order2": "詩歌敬拜",
    "services.sunday.order3": "證道回應",
    "services.sunday.order4": "殿樂祈禱",
    "services.sunday.order5": "歡迎新人",
    "services.sunday.order6": "分享代禱",
    "services.group.title": "家庭小組",
    "services.group.time": "週間 · 地點待確認",
    "services.group.desc": "在小組中分享生活、查考聖經、彼此代禱。",
    "services.prayer.title": "禱告會",
    "services.prayer.time": "時間待確認",
    "services.prayer.desc": "一同為教會、家庭、城市與宣教守望。",
    "new.kicker": "New Here",
    "new.title": "第一次來也很自然",
    ...
    "new.step3.title": "孩子與家庭",
    "new.step3.copy": "兒童與家庭安排待確認，首版先保留說明位置。",
  ...
  en: {
    ...
    "hero.copy": "Encountering the light of life in Christ as we worship, grow, and serve Auckland together.",
    "hero.primary": "I am new",
    "hero.secondary": "View gathering times",
    "welcome.kicker": "Welcome Home",
    "welcome.title": "Welcome to Light of Life",
    "welcome.copy": "Whether you are exploring faith, new to Auckland, or looking for a spiritual home, you are welcome to worship, pray, study Scripture, and grow with us in community.",
    "about.kicker": "About Us",
    ...
    "services.sunday.order1": "Pre-service prayer",
    "services.sunday.order2": "Praise and worship",
    "services.sunday.order3": "Sermon response",
    "services.sunday.order4": "Closing prayer",
    "services.sunday.order5": "Welcoming newcomers",
    "services.sunday.order6": "Sharing and prayer requests",
    "services.group.title": "Home Groups",
    "services.group.time": "Weekdays · Location to be confirmed",
    "services.group.desc": "Sharing life, studying Scripture, and praying for one another.",
    "services.prayer.title": "Prayer Meeting",
    "services.prayer.time": "Time to be confirmed",
    "services.prayer.desc": "Praying together for the church, families, the city, and mission.",
    "new.kicker": "New Here",
    "new.title": "Your first visit can feel simple",
    ...
    "new.step3.title": "Children and families",
    "new.step3.copy": "Children and family arrangements are to be confirmed. This section is reserved for launch details.",
